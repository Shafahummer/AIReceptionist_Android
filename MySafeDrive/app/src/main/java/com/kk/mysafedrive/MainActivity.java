...
public class MainActivity extends AppCompatActivity {
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        GraphicFaceTracker(GraphicOverlay overlay) {
            ...
            this.mFaceGraphic = new FaceGraphic(this.mOverlay, MainActivity.this.mAlertHandler);
        }
    ...
    private void createCameraSource() {
        ...
        FaceDetector detector = new Builder(context).setProminentFaceOnly(true).setClassificationType(MSG_DISMISS_DIALOG).setTrackingEnabled(true).setMinFaceSize(MIN_FACE_SIZE_RATIO).build();
